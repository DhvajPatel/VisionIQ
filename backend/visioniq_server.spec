...
a = Analysis(
    ...
    excludes=[
        ...
        "tkinter", "_tkinter",
        # torch.distributed uses inspect.getsource() at import time which
        # crashes inside a PyInstaller bundle (no .py source files exist).
        # None of these are needed for CPU inference.
        "torch.distributed",
